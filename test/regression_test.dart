...
void main() {
  group('Regressão - Resolucao.fromMap', () {
    test(
      'não deve lançar exceção quando o mapa contém apenas chaves parciais',
      () {
    ...
    test(
      'não deve lançar exceção quando o mapa é completamente nulo/vazio',
      () {
  ...
  group('Regressão - Post.toMap / copyWith', () {
    test(
      'copyWith não deve sobrescrever campos com null ao não informá-los',
      () {
        final original = Post(
          id: '1',
          uid: 'user1',
